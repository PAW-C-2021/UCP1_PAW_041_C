...
namespace ClothingStore.Controllers
{
    public class ProduksController : Controller
    {
        ...
        public ProduksController(ClothingStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProduk,NamaProduk,Ukuran,Brand")] Produk produk)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProduk,NamaProduk,Ukuran,Brand")] Produk produk)
        {
