...
namespace ClothingStore.Controllers
{
    public class PembelisController : Controller
    {
        ...
        public PembelisController(ClothingStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPembeli,NamaPembeli,NoHp,Email")] Pembeli pembeli)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPembeli,NamaPembeli,NoHp,Email")] Pembeli pembeli)
        {
